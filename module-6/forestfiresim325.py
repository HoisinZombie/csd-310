...
EMPTY = ' '
WATER = 'W'
#add a new constant for water
INITIAL_TREE_DENSITY = 0.20
# Amount of forest that starts with trees.
GROW_CHANCE = 0.01
# Chance a blank space turns into a tree.
FIRE_CHANCE = 0.01
# Chance a tree is hit by lightning & burns.
PAUSE_LENGTH = 0.5
...
if (x,y) in forest:
#if (x,y) already exists, it is water, so don't change it
continue
else:
...
bext.fg('red')
print(FIRE, end='')#add an elif statement to display the water
